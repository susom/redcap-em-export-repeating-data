...
<div class="content"  style="margin-bottom:10px; padding-left: 10px; padding-right: 20px;">
    <form name="export-repeating" id="export-repeating">
        ...
        <div class="row">
            ...
            <div class="modal" id="promptForNameSaveReport" tabindex="-1" role="dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body ">
                            <div class="row">
                                <div class="col-3" >
                                    Save report as: </div>
                                <div class="col-9"><input class="ui-corner-all input-group" type="text" id="report_name_modal" />
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" onclick="saveExportJson()" data-dismiss="modal">Save report</button>
